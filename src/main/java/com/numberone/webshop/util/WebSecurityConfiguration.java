...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
  ...
  JwtDecoder jwtDecoder() {
	...
	CorsConfigurationSource corsConfigurationSource() {
		...
		configuration.setAllowedOrigins(Arrays.asList("http://localhost:8080", "http://hybrid-cloud-number-1-ucllteam01.ocp-ucll-40cb0df2b03969eabb3fac6e80373775-0000.eu-de.containers.appdomain.cloud"));
